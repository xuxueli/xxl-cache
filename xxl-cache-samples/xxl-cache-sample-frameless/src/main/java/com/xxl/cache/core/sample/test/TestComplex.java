...
public class TestComplex {
    ...
    private static XxlCacheFactory initAndStart(){
        ...
        xxlCacheFactory.setRedisDbIndex(Integer.valueOf(prop.getProperty("xxl.cache.l2.dbIndex")));
